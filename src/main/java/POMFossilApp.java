...
public class POMFossilApp {
    ...
    public static void singUpApp(AndroidDriver driver) throws InterruptedException{
        ...
        final MobileElement element2 = waitForElement(driver, By.id("com.fossil.wearables.fossil.staging:id/tv_login"));
        if (element2 != null) {
            element2.click();
        }

        final MobileElement element3 = waitForElement(driver, By.id("com.fossil.wearables.fossil.staging:id/tv_signup"));
        if (element3 != null) {
            element3.click();
        }

        final MobileElement element4 = waitForElement(driver, By.id("com.fossil.wearables.fossil.staging:id/tv_login"));
        if (element4 != null) {
            element4.click();
        }
